    ...
    public class StartUp
    {
        static void Main()
        {
            ...
            foreach (var car in carsList)
            {
                if (car.Year >= 2017)
                {
                    if (enginesList[car.Engine].HorsePower > 330)
                    {
                        double sum = 0;

                        sum += tiresList[car.Tires][0].Pressure;
                        sum += tiresList[car.Tires][1].Pressure;
                        sum += tiresList[car.Tires][2].Pressure;
                        sum += tiresList[car.Tires][3].Pressure;
                        ...
                        if (sum >= 9 && sum <= 10)
                        {
                            ...
                            Console.WriteLine($"HorsePowers: {enginesList[car.Engine].HorsePower}");
