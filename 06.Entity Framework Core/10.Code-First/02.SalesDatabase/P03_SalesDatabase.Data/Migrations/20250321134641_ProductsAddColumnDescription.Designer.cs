...
namespace P03_SalesDatabase.Data.Migrations
{
    ...
    [Migration("20250321134641_ProductsAddColumnDescription")]
            ...
            modelBuilder.Entity("P03_SalesDatabase.Data.Models.Sale", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SaleId = 1,
                            CustomerId = 2,
                            Date = new DateTime(2025, 3, 21, 15, 46, 40, 909, DateTimeKind.Local).AddTicks(6170),
                            ProductId = 1,
                            StoreId = 3
                        },
                        new
                        {
                            SaleId = 2,
                            CustomerId = 1,
                            Date = new DateTime(2025, 3, 20, 15, 46, 40, 909, DateTimeKind.Local).AddTicks(6204),
                            ProductId = 3,
                            StoreId = 2
                        },
                        new
                        {
                            SaleId = 3,
                            CustomerId = 5,
                            Date = new DateTime(2025, 3, 19, 15, 46, 40, 909, DateTimeKind.Local).AddTicks(6208),
                            ProductId = 2,
                            StoreId = 4
                        },
                        new
                        {
                            SaleId = 4,
                            CustomerId = 3,
                            Date = new DateTime(2025, 3, 18, 15, 46, 40, 909, DateTimeKind.Local).AddTicks(6211),
                            ProductId = 4,
                            StoreId = 1
                        },
                        new
                        {
                            SaleId = 5,
                            CustomerId = 4,
                            Date = new DateTime(2025, 3, 17, 15, 46, 40, 909, DateTimeKind.Local).AddTicks(6213),
                            ProductId = 5,
                            StoreId = 5
                        });
                });
