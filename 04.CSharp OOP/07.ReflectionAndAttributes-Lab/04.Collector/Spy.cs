...
namespace Stealer
{
    public class Spy
    {
        ...
        public string CollectingGettersAndSetters(string className)
        {
            ...
            foreach (PropertyInfo property in properties)
            {
                ...
                if (setMethod is not null) output.Add($"{setMethod.Name} will set field to {property.PropertyType.FullName}");
            }
