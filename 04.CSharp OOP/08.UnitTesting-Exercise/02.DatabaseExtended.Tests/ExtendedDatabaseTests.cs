namespace DatabaseExtended.Tests
{
    ...
    public class ExtendedDatabaseTests
    {
        ...
        {
            Person[] data = GenerateRandomPeople(elementsCount);
        ...
        public void AddShouldWorkCorrectly()
        {
            ...
            List<Person> addedPeople = new List<Person>();
            ...
            for (int i = 0; i < MaxCapacity; i++)
            {
                ...
                {
                    AssertIsFound(database, person);
                }
            }
        }

        [Test]
        public void AddShouldThrowIfDatabaseIsAlreadyFailed()
        {
            Person[] data = GenerateRandomPeople(MaxCapacity);
