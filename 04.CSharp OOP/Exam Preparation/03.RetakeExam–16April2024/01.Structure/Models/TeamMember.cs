...
namespace TheContentDepartment.Models
{
    public abstract class TeamMember : ITeamMember
    {
        ...
        public void FinishTask(string resourceName) => this._inProgress.Add(resourceName);

        public void WorkOnTask(string resourceName) => this._inProgress.Remove(resourceName);
